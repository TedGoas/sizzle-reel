...
export const SCALE_OPTIONS = ['Excellent', 'Good', 'Fair', 'Poor', 'Very poor']
...
export const scorecardQuestions = [
  ...
  {
    text: 'Did the agent properly confirm the identity of the user?',
    points: 10,
    options: YES_NO_OPTIONS,
    aiSuggest: 'Yes',
    answer: 'Yes',
  ...
  {
    text: 'How was the agent’s understanding of the issue/request?',
    points: 10,
  ...
  {
    text: 'Did the agent attempt to find a workaround or troubleshoot with the user?',
    points: 10,
    options: SCALE_OPTIONS,
    aiSuggest: null,
    answer: 'Good',
  ...
  {
    text: 'Did the agent ask to put the customer on hold?',
    points: 10,
    options: YES_NO_OPTIONS,
    aiSuggest: 'No',
    answer: 'No',
  ...
  {
    text: 'Did the agent provide a call closing statement?',
    points: 10,
    options: YES_NO_OPTIONS,
    aiSuggest: 'Yes',
    answer: 'Yes',
